...
const jhipsterHelidonVersion = require('../../package.json').version;
...
module.exports = class extends CommonGenerator {
    ...
    get default() {
        ...
        const phaseFromHelidon = {
            defineJHipsterHelidonVersion() {
                this.jhipsterHelidonVersion = jhipsterHelidonVersion;
            },
        };
        return Object.assign(phaseFromJHipster, phaseFromHelidon);
    }

    get writing() {
        const phaseFromJHipster = super._writing();
        const phaseFromHelidon = writeFiles();
        return Object.assign(phaseFromJHipster, phaseFromHelidon);
    }
